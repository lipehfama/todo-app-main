...
<table>
  ...
  <tr valign="top">
    <td><img height="630" src="./docs/screenshots/mobile-design-light.jpg" alt="Todo app mobile light theme" /></td>
    <td><img height="630" src="./docs/screenshots/mobile-design-dark.jpg" alt="Todo app mobile dark theme" /></td>
  </tr>
  <tr>
    <td>Desktop Light</td>
    <td>Desktop Dark</td>
  ...
  <tr valign="top">
    <td><img height="430" src="./docs/screenshots/desktop-design-light.jpg" alt="Todo app desktop light theme" /></td>
    <td><img height="430" src="./docs/screenshots/desktop-design-dark.jpg" alt="Todo app desktop dark theme" /></td>
  </tr>
  <tr>
  ...
  <tr valign="top">
    <td><img height="430" src="./docs/screenshots/active-states-light.jpg" alt="Todo app active states in light theme" /></td>
    <td><img height="430" src="./docs/screenshots/active-states-dark.jpg" alt="Todo app active states in dark theme" /></td>
  </tr>
</table>
